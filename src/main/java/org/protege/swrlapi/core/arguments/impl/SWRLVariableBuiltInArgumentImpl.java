...
class SWRLVariableBuiltInArgumentImpl extends SWRLBuiltInArgumentImpl implements SWRLVariableBuiltInArgument
{
	...
	public boolean equals(Object obj)
	{
		...
		return (((this.getVariableName() == impl.getVariableName() || this.getVariableName() != null
				&& this.getVariableName().equals(impl.getVariableName()))));
	}
	...
	{
		int hash = 58;
		hash = hash + (null == this.getVariableName() ? 0 : this.getVariableName().hashCode());
		return hash;
	}
}
