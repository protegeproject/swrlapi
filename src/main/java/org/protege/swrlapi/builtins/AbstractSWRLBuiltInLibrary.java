...
public abstract class AbstractSWRLBuiltInLibrary implements SWRLBuiltInLibrary
{
	...
	@Override
	public URI getArgumentAsAnIndividualURI(int argumentNumber, List<SWRLBuiltInArgument> arguments)
			throws BuiltInException
	{
		checkThatArgumentIsAnIndividual(argumentNumber, arguments);

		return ((SWRLIndividualBuiltInArgument)arguments.get(argumentNumber)).getURI();
	}
	...
	@Override
	public URI getArgumentAsAClassURI(int argumentNumber, List<SWRLBuiltInArgument> arguments) throws BuiltInException
	{
		checkThatArgumentIsAClass(argumentNumber, arguments);

		return ((SWRLClassBuiltInArgument)arguments.get(argumentNumber)).getURI();
	}
	...
	@Override
	public URI getArgumentAsAURI(int argumentNumber, List<SWRLBuiltInArgument> arguments) throws BuiltInException
	{
		...
		if (isArgumentAClass(argumentNumber, arguments))
			...
			return ((SWRLPropertyBuiltInArgument)arguments.get(argumentNumber)).getURI();
	...
	@Override
	public URI getArgumentAsAPropertyURI(int argumentNumber, List<SWRLBuiltInArgument> arguments) throws BuiltInException
	{
		checkThatArgumentIsAProperty(argumentNumber, arguments);
	...
	@Override
	public SWRLAPILiteral getArgumentAsASWRLAPILiteral(int argumentNumber, List<SWRLBuiltInArgument> arguments)
			throws BuiltInException
	{
		checkThatArgumentIsALiteral(argumentNumber, arguments);
	...
	@Override
	public SWRLAPILiteral getArgumentAsASWRLAPILiteral(SWRLBuiltInArgument argument) throws BuiltInException
	{
	 ...
	 * URIs; data value objects are represented by the appropriate Java type. Primitive XSD datatypes that do not have a
			...
			throws BuiltInException
	{
		...
		if (argument instanceof SWRLClassBuiltInArgument) {
			...
			SWRLIndividualBuiltInArgument individualArgument = (SWRLIndividualBuiltInArgument)argument;
			return individualArgument.getURI();
		} else if (argument instanceof SWRLLiteralBuiltInArgument) {
	...
	@Override
	public URI createURI(String fullName) throws BuiltInException
	{
		try {
			return new URI(fullName);
		} catch (URISyntaxException e) {
			throw new BuiltInException("error creating URI from full name " + fullName + ": " + e.getMessage(), e);
		}
	}
	...
	@Override
	public SWRLClassBuiltInArgument createClassBuiltInArgument(URI classURI, String prefixedName) throws BuiltInException
	{
	...
	@Override
	public SWRLIndividualBuiltInArgument createIndividualBuiltInArgument(URI individualURI, String prefixedName)
			throws BuiltInException
	{
	...
	@Override
	public SWRLObjectPropertyBuiltInArgument createObjectPropertyBuiltInArgument(URI propertyURI, String prefixedName)
			throws BuiltInException
	{
	...
	{
		return getBuiltInArgumentFactory().createLiteralArgument(date);
	}

	@Override
	public SWRLLiteralBuiltInArgument createLiteralBuiltInArgument(XSDTime time) throws BuiltInException
	{
		return getBuiltInArgumentFactory().createLiteralArgument(time);
	}

	@Override
	public SWRLLiteralBuiltInArgument createLiteralBuiltInArgument(XSDDateTime dateTime) throws BuiltInException
	{
		return getBuiltInArgumentFactory().createLiteralArgument(dateTime);
	}

	@Override
	public SWRLLiteralBuiltInArgument createLiteralBuiltInArgument(XSDDuration duration) throws BuiltInException
	{
		return getBuiltInArgumentFactory().createLiteralArgument(duration);
	}

	@Override
	public SWRLLiteralBuiltInArgument createLiteralBuiltInArgument(URI uri) throws BuiltInException
	{
		return getBuiltInArgumentFactory().createLiteralArgument(uri);
	}

	@Override
	public SWRLAPILiteral createSWRLAPILiteral(String s) throws BuiltInException
	{
		return getSWRLAPILiteralFactory().getSWRLAPILiteral(s);
	}

	@Override
	public SWRLAPILiteral createSWRLAPILiteral(boolean b) throws BuiltInException
	{
		return getSWRLAPILiteralFactory().getSWRLAPILiteral(b);
	}

	@Override
	public SWRLAPILiteral createSWRLAPILiteral(Byte b) throws BuiltInException
	{
		return getSWRLAPILiteralFactory().getSWRLAPILiteral(b);
	}

	@Override
	public SWRLAPILiteral createSWRLAPILiteral(short s) throws BuiltInException
	{
		return getSWRLAPILiteralFactory().getSWRLAPILiteral(s);
	}

	@Override
	public SWRLAPILiteral createSWRLAPILiteral(int i) throws BuiltInException
	{
		return getSWRLAPILiteralFactory().getSWRLAPILiteral(i);
	}

	@Override
	public SWRLAPILiteral createSWRLAPILiteral(long l) throws BuiltInException
	{
		return getSWRLAPILiteralFactory().getSWRLAPILiteral(l);
	}

	@Override
	public SWRLAPILiteral createSWRLAPILiteral(float f) throws BuiltInException
	{
		return getSWRLAPILiteralFactory().getSWRLAPILiteral(f);
	}

	@Override
	public SWRLAPILiteral createSWRLAPILiteral(double d) throws BuiltInException
	{
		return getSWRLAPILiteralFactory().getSWRLAPILiteral(d);
	}

	@Override
	public SWRLAPILiteral createSWRLAPILiteral(URI uri) throws BuiltInException
	{
		return getSWRLAPILiteralFactory().getSWRLAPILiteral(uri);
	}

	@Override
	public SWRLAPILiteral createSWRLAPILiteral(XSDDate date) throws BuiltInException
	{
		return getSWRLAPILiteralFactory().getSWRLAPILiteral(date);
	}

	@Override
	public SWRLAPILiteral createSWRLAPILiteral(XSDTime time) throws BuiltInException
	{
		return getSWRLAPILiteralFactory().getSWRLAPILiteral(time);
	}

	@Override
	public SWRLAPILiteral createSWRLAPILiteral(XSDDateTime dateTime) throws BuiltInException
	{
		return getSWRLAPILiteralFactory().getSWRLAPILiteral(dateTime);
	}

	@Override
	public SWRLAPILiteral createSWRLAPILiteral(XSDDuration duration) throws BuiltInException
	{
		return getSWRLAPILiteralFactory().getSWRLAPILiteral(duration);
	}

	@Override
	public SWRLMultiArgument createMultiArgument() throws BuiltInException
	{
		return getBuiltInArgumentFactory().createMultiArgument();
	}

	@Override
	public SWRLMultiArgument createMultiArgument(List<SWRLBuiltInArgument> arguments) throws BuiltInException
	{
		return getBuiltInArgumentFactory().createMultiArgument(arguments);
	}
	...
	{
		return getBuiltInArgumentFactory().createSQWRLCollectionArgument(queryName, collectionName, collectionGroupID);
	}
