...
import org.protege.swrlapi.exceptions.IncompatibleBuiltInClassException;
import org.protege.swrlapi.exceptions.IncompatibleBuiltInMethodException;
import org.protege.swrlapi.exceptions.SWRLBuiltInLibraryException;
import org.protege.swrlapi.exceptions.UnresolvedBuiltInClassException;
import org.protege.swrlapi.exceptions.UnresolvedBuiltInMethodException;
...
public abstract class SWRLBuiltInLibraryManager
{
	 ...
	 * {@link org.protege.swrlapi.core.SWRLRuleEngineBridge} and should not be called directly from a rule engine. The
	 * built-in name should be the prefixed name of the built-in (e.g., swrlb:lessThanOrEqual).
	 * <p>
