package org.protege.swrlapi.owl2rl;
...
public interface OWL2RLNames
{
	...
	Rule[] Table4Rules = { Rule.EQ_REF, Rule.EQ_SYM, Rule.EQ_TRANS, Rule.EQ_REP_S, Rule.EQ_REP_P, Rule.EQ_REP_O, Rule.EQ_DIFF1, Rule.EQ_DIFF2, Rule.EQ_DIFF3 };

	Rule[] Table5Rules = { Rule.PRP_AP, Rule.PRP_DOM, Rule.PRP_RNG, Rule.PRP_FP, Rule.PRP_IFP, Rule.PRP_IRP, Rule.PRP_SYMP, Rule.PRP_ASYP, Rule.PRP_TRP, Rule.PRP_SPO1, Rule.PRP_SPO2, Rule.PRP_EQP1, Rule.PRP_EQP2,
			Rule.PRP_PDW, Rule.PRP_ADP, Rule.PRP_INV1, Rule.PRP_INV2, Rule.PRP_KEY, Rule.PRP_NPA1, Rule.PRP_NPA2 };

	Rule[] Table6Rules = { Rule.CLS_THING, Rule.CLS_NOTHING1, Rule.CLS_NOTHING2, Rule.CLS_INT1, Rule.CLS_INT2, Rule.CLS_UNI, Rule.CLS_COM, Rule.CLS_SFV1, Rule.CLS_SFV2, Rule.CLS_AVF, Rule.CLS_HV1,
			Rule.CLS_HV2, Rule.CLS_MAXC1, Rule.CLS_MAXC2, Rule.CLS_MAXQC1, Rule.CLS_MAXQC2, Rule.CLS_MAXQC3, Rule.CLS_MAXQC4, Rule.CLS_OO };
	...
	Rule[] Table9Rules = { Rule.SCM_CLS, Rule.SCM_SCO, Rule.SCM_EQC1, Rule.SCM_EQC2, Rule.SCM_OP, Rule.SCM_DP, Rule.SCM_SPO, Rule.SCM_EQP1, Rule.SCM_EQP2, Rule.SCM_DOM1, Rule.SCM_DOM2, Rule.SCM_RNG1, Rule.SCM_RNG2,
