 ...
 * atoms in the SWRLAPI, which has a wider range of built-in argument types than the OWLAPI. The OWLAPI envisions
 * built-in arguments as simple literals or variables only. In addition to literals and variables, the SWRLAPI allows
 * OWL named objects (classes, named individuals, properties, datatypes) as well as SQWRL-specific arguments.
 * 
