...
public class DefaultSQWRLResultValueFactory implements SQWRLResultValueFactory
{
	...
	{
		String prefixedName = getOWLIRIResolver().iri2ShortName(classIRI);
	...
	{
		String prefixedName = getOWLIRIResolver().iri2ShortName(individualIRI);
	...
	{
		String prefixedName = getOWLIRIResolver().iri2ShortName(propertyIRI);
	...
	{
		String prefixedName = getOWLIRIResolver().iri2ShortName(dataPropertyArgument.getIRI());
	...
	{
		String prefixedName = getOWLIRIResolver().iri2ShortName(annotationPropertyArgument.getIRI());
