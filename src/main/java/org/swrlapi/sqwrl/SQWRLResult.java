...
public interface SQWRLResult
{
	 ...
	 */
	@NonNull
	SQWRLObjectPropertyResultValue getObjectProperty(@NonNull String columnName) throws SQWRLException;
	 ...
	 */
	@NonNull
	SQWRLDataPropertyResultValue getDataProperty(@NonNull String columnName) throws SQWRLException;
	 ...
	 */
	@NonNull
	SQWRLAnnotationPropertyResultValue getAnnotationProperty(@NonNull String columnName) throws SQWRLException;
	 ...
	 */
	@NonNull
	SQWRLLiteralResultValue getLiteral(@NonNull String columnName) throws SQWRLException;
	 ...
	 */
	@NonNull
	SQWRLResultValue getValue(@NonNull String columnName) throws SQWRLException;
	 ...
	 */
	@NonNull
	List<SQWRLResultValue> getColumn(@NonNull String columnName) throws SQWRLException;
