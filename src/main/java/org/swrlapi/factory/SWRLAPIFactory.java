...
public class SWRLAPIFactory
{
	 ...
	 */
	@NonNull public static SWRLRuleRenderer getSWRLRuleRenderer(@NonNull OWLOntology ontology,
	 ...
	 */
	@NonNull public static SQWRLQueryRenderer getSQWRLQueryRenderer(@NonNull OWLOntology ontology,
			DefaultPrefixManager prefixManager)
	{
		return new DefaultSWRLRuleAndQueryRenderer(ontology, prefixManager);
	}
	 ...
	 */
	@NonNull public static OWL2RLPersistenceLayer getOWL2RLPersistenceLayer(@NonNull OWLOntology ontology)
	{
	 ...
	 */
	@NonNull public static IRIResolver getIRIResolver()
	{
	 ...
	 * @return An IRI resolver
	 */
	@NonNull public static IRIResolver getIRIResolver(@NonNull DefaultPrefixManager prefixManager)
	{
