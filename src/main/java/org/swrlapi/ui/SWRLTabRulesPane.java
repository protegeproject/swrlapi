...
public class SWRLTabRulesPane extends JTabbedPane
{
	...
	public SWRLTabRulesPane(SWRLRuleEngine ruleEngine, Icon ruleEngineIcon, Icon reasonerIcon)
	{
		addTab("Control", ruleEngineIcon, new SWRLTabRulesControlPanel(ruleEngine), "Control Tab");

		addTab("Rules", ruleEngineIcon, new SWRLTabRuleListPanel(ruleEngine), "Rules Tab");
