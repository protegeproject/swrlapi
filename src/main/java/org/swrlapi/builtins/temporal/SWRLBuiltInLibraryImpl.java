...
public class SWRLBuiltInLibraryImpl extends AbstractSWRLBuiltInLibrary
{
			...
			throws SWRLBuiltInException, TemporalException
	{
		if (isArgumentALiteral(argumentNumber, arguments)) {
			...
			if (isOWLIndividualOfType(individualIRI, createIRI(ValidInstantClassName))) {
				...
				throw new InvalidSWRLBuiltInArgumentException(argumentNumber,
						"individual " + individualIRI + " is not a " + ValidInstantClassName + " or " + ValidPeriodClassName
								+ " or " + ExtendedPropositionClassName);
		} else
			throw new InvalidSWRLBuiltInArgumentException(argumentNumber,
	...
	private Instant validInstantIndividual2Instant(IRI individualIRI, int granularity)
			throws SWRLBuiltInException, TemporalException
	{
	...
	private Period validPeriodIndividual2Period(IRI individualIRI, int granularity)
			throws SWRLBuiltInException, TemporalException
	{
