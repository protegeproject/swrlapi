...
class XSDDateTimeStringProcessor extends DatetimeStringProcessor
{
  ...
  {
    super(new SimpleDateFormat("y-M-d'T'h:m:s.S"), _delimiters, _gTokenIndex, _datetimeRoundDownPadding, _datetimeRoundUpPadding);
  }

  @NotNull @NonNull @Override protected String constructDatetimeStringFromMillisecondsFrom1970Count(long millisecondsFrom1970)
  {
