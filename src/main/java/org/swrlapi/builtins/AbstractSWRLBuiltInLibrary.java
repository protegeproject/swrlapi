		...
		SWRLBuiltInResultArgumentHandler, SWRLBuiltInArgumentCreator
{
	...
	@NonNull
	@Override
	public String createInvocationPattern(@NonNull SWRLBuiltInBridge bridge, @NonNull String ruleName, int builtInIndex,
			boolean inConsequent, @NonNull List<SWRLBuiltInArgument> arguments) throws SWRLBuiltInException
	{
	...
	@NonNull
	@Override
	public IRI createIRI(@NonNull String fullName) throws SWRLBuiltInException
	{
		try {
	...
	@Override
	public void checkThatAllArgumentsAreLiterals(@NonNull List<SWRLBuiltInArgument> arguments)
			throws SWRLBuiltInException
	{
	...
	@Override
	public void checkThatAllArgumentsAreNumeric(@NonNull List<SWRLBuiltInArgument> arguments) throws SWRLBuiltInException
	{
		for (int argumentNumber = 0; argumentNumber < arguments.size(); argumentNumber++)
	...
	@Override
	public void checkThatAllArgumentsAreIntegers(@NonNull List<SWRLBuiltInArgument> arguments)
			throws SWRLBuiltInException
	{
		for (int argumentNumber = 0; argumentNumber < arguments.size(); argumentNumber++)
	...
	@Override
	public boolean areAllArgumentsBytes(@NonNull List<SWRLBuiltInArgument> arguments) throws SWRLBuiltInException
	{
		for (int argumentNumber = 0; argumentNumber < arguments.size(); argumentNumber++)
	...
	@Override
	public boolean areAllArgumentsShorts(@NonNull List<SWRLBuiltInArgument> arguments) throws SWRLBuiltInException
	{
		for (int argumentNumber = 0; argumentNumber < arguments.size(); argumentNumber++)
	...
	@Override
	public boolean areAllArgumentsIntegers(@NonNull List<SWRLBuiltInArgument> arguments) throws SWRLBuiltInException
	{
		for (int argumentNumber = 0; argumentNumber < arguments.size(); argumentNumber++)
	...
	@Override
	public boolean areAllArgumentsLongs(@NonNull List<SWRLBuiltInArgument> arguments) throws SWRLBuiltInException
	{
		for (int argumentNumber = 0; argumentNumber < arguments.size(); argumentNumber++)
	...
	@Override
	public boolean areAllArgumentsFloats(@NonNull List<SWRLBuiltInArgument> arguments) throws SWRLBuiltInException
	{
		for (int argumentNumber = 0; argumentNumber < arguments.size(); argumentNumber++)
	...
	@Override
	public boolean areAllArgumentsDoubles(@NonNull List<SWRLBuiltInArgument> arguments) throws SWRLBuiltInException
	{
		for (int argumentNumber = 0; argumentNumber < arguments.size(); argumentNumber++)
	...
	@Override
	public boolean isArgumentConvertibleToByte(int argumentNumber, @NonNull List<SWRLBuiltInArgument> arguments)
			throws SWRLBuiltInException
	{
	...
	@Override
	public boolean isArgumentConvertibleToShort(int argumentNumber, @NonNull List<SWRLBuiltInArgument> arguments)
			throws SWRLBuiltInException
	{
	...
	@Override
	public boolean isArgumentConvertibleToInteger(int argumentNumber, @NonNull List<SWRLBuiltInArgument> arguments)
			throws SWRLBuiltInException
	{
		return (isArgumentNumeric(argumentNumber, arguments) && isArgumentAByte(argumentNumber, arguments)
	...
	@Override
	public boolean isArgumentConvertibleToLong(int argumentNumber, @NonNull List<SWRLBuiltInArgument> arguments)
			throws SWRLBuiltInException
	{
		return (isArgumentNumeric(argumentNumber, arguments) && isArgumentAByte(argumentNumber, arguments)
	...
	@Override
	public boolean isArgumentConvertibleToFloat(int argumentNumber, @NonNull List<SWRLBuiltInArgument> arguments)
			throws SWRLBuiltInException
	{
		return (isArgumentNumeric(argumentNumber, arguments) && isArgumentAByte(argumentNumber, arguments)
				&& isArgumentAShort(argumentNumber, arguments) && isArgumentAnInt(argumentNumber, arguments)
	...
	@Override
	public boolean isArgumentConvertibleToDouble(int argumentNumber, @NonNull List<SWRLBuiltInArgument> arguments)
			throws SWRLBuiltInException
	{
	...
	@Override
	public boolean isWidestNumericArgumentAByte(@NonNull List<SWRLBuiltInArgument> arguments) throws SWRLBuiltInException
	{
		for (int argumentNumber = 0; argumentNumber < arguments.size(); argumentNumber++)
	...
	@Override
	public boolean isWidestNumericArgumentAShort(@NonNull List<SWRLBuiltInArgument> arguments)
			throws SWRLBuiltInException
	{
		for (int argumentNumber = 0; argumentNumber < arguments.size(); argumentNumber++)
	...
	@Override
	public boolean isWidestNumericArgumentAnInt(@NonNull List<SWRLBuiltInArgument> arguments) throws SWRLBuiltInException
	{
		for (int argumentNumber = 0; argumentNumber < arguments.size(); argumentNumber++)
	...
	@Override
	public boolean isWidestNumericArgumentALong(@NonNull List<SWRLBuiltInArgument> arguments) throws SWRLBuiltInException
	{
		for (int argumentNumber = 0; argumentNumber < arguments.size(); argumentNumber++)
	...
	@Override
	public boolean isWidestNumericArgumentAFloat(@NonNull List<SWRLBuiltInArgument> arguments)
			throws SWRLBuiltInException
	{
		for (int argumentNumber = 0; argumentNumber < arguments.size(); argumentNumber++)
			if (isArgumentADouble(argumentNumber, arguments))
	...
	@Override
	public boolean areAllArgumentsBooleans(@NonNull List<SWRLBuiltInArgument> arguments) throws SWRLBuiltInException
	{
		for (int argumentNumber = 0; argumentNumber < arguments.size(); argumentNumber++)
	...
	@Override
	public boolean areAllArgumentLiterals(@NonNull List<SWRLBuiltInArgument> arguments) throws SWRLBuiltInException
	{
		for (int argumentNumber = 0; argumentNumber < arguments.size(); argumentNumber++)
	...
	@Override
	public boolean areAllArgumentsNumeric(@NonNull List<SWRLBuiltInArgument> arguments) throws SWRLBuiltInException
	{
		for (int argumentNumber = 0; argumentNumber < arguments.size(); argumentNumber++)
	...
	@Override
	public boolean areAllArgumentsStrings(@NonNull List<SWRLBuiltInArgument> arguments) throws SWRLBuiltInException
	{
		for (int argumentNumber = 0; argumentNumber < arguments.size(); argumentNumber++)
	...
	@Override
	public boolean areAllArgumentsOfAnOrderedType(@NonNull List<SWRLBuiltInArgument> arguments)
			throws SWRLBuiltInException
	{
		for (int argumentNumber = 0; argumentNumber < arguments.size(); argumentNumber++)
	...
	@Override
	public void checkThatAllArgumentsAreFloats(@NonNull List<SWRLBuiltInArgument> arguments) throws SWRLBuiltInException
	{
		for (int argumentNumber = 0; argumentNumber < arguments.size(); argumentNumber++)
	...
	@Override
	public void checkThatAllArgumentsAreStrings(@NonNull List<SWRLBuiltInArgument> arguments) throws SWRLBuiltInException
	{
		for (int argumentNumber = 0; argumentNumber < arguments.size(); argumentNumber++)
	...
	@Override
	public void checkThatAllArgumentsAreOfAnOrderedType(@NonNull List<SWRLBuiltInArgument> arguments)
			throws SWRLBuiltInException
	{
		for (int argumentNumber = 0; argumentNumber < arguments.size(); argumentNumber++)
	...
	@Override
	public void checkThatArgumentIsNumeric(int argumentNumber, @NonNull List<SWRLBuiltInArgument> arguments)
			throws SWRLBuiltInException
	{
		if (!isArgumentNumeric(argumentNumber, arguments))
	...
	@Override
	public void checkThatArgumentIsOfAnOrderedType(int argumentNumber, @NonNull List<SWRLBuiltInArgument> arguments)
			throws SWRLBuiltInException
	{
		if (!isArgumentOfAnOrderedType(argumentNumber, arguments))
			throw new InvalidSWRLBuiltInArgumentException(argumentNumber, makeInvalidArgumentTypeMessage(
	...
	@Override
	public boolean isArgumentOfAnOrderedType(int argumentNumber, @NonNull List<SWRLBuiltInArgument> arguments)
			throws SWRLBuiltInException
	{
	...
	@Override
	public boolean isArgumentAnIndividual(int argumentNumber, @NonNull List<SWRLBuiltInArgument> arguments)
			throws SWRLBuiltInException
	{
	...
	@Override
	public void checkThatArgumentIsAnIndividual(int argumentNumber, @NonNull List<SWRLBuiltInArgument> arguments)
			throws SWRLBuiltInException
	{
	...
	@Override
	public void checkThatArgumentIsALiteral(int argumentNumber, @NonNull List<SWRLBuiltInArgument> arguments)
			throws SWRLBuiltInException
	{
		if (!isArgumentALiteral(argumentNumber, arguments)) {
			throw new InvalidSWRLBuiltInArgumentException(argumentNumber, makeInvalidArgumentTypeMessage(
					arguments.get(argumentNumber), "literal"));
		}
	}

	@NonNull
	@Override
	public IRI getArgumentAsAnIndividualIRI(int argumentNumber, @NonNull List<SWRLBuiltInArgument> arguments)
			throws SWRLBuiltInException
	{
	...
	@NonNull
	@Override
	public IRI getArgumentAsAClassIRI(int argumentNumber, @NonNull List<SWRLBuiltInArgument> arguments)
			throws SWRLBuiltInException
	{
	...
	@NonNull
	@Override
	public SWRLClassBuiltInArgument getArgumentAsAClass(int argumentNumber, @NonNull List<SWRLBuiltInArgument> arguments)
			throws SWRLBuiltInException
	{
		checkThatArgumentIsAClass(argumentNumber, arguments);
	...
	@NonNull
	@Override
	public IRI getArgumentAsAnIRI(int argumentNumber, @NonNull List<SWRLBuiltInArgument> arguments)
			throws SWRLBuiltInException
	{
		...
		if (isArgumentAClass(argumentNumber, arguments))
			...
			throw new SWRLBuiltInException("internal error: unknown argument type "
					+ arguments.get(argumentNumber).getClass());
	}

	@NonNull
	@Override
	public IRI getArgumentAsAPropertyIRI(int argumentNumber, @NonNull List<SWRLBuiltInArgument> arguments)
			throws SWRLBuiltInException
	{
		checkThatArgumentIsAProperty(argumentNumber, arguments);
	...
	@Override
	public void checkArgumentNumber(int argumentNumber, @NonNull List<SWRLBuiltInArgument> arguments)
			throws SWRLBuiltInException
	{
	...
	@Override
	public boolean isArgumentNumeric(int argumentNumber, @NonNull List<SWRLBuiltInArgument> arguments)
			throws SWRLBuiltInException
	{
	...
	@Override
	public boolean isArgumentNonNumeric(int argumentNumber, @NonNull List<SWRLBuiltInArgument> arguments)
			throws SWRLBuiltInException
	{
		return isArgumentALiteral(argumentNumber, arguments)
				&& !getArgumentAsALiteral(argumentNumber, arguments).isNumeric();
	...
	@Override
	public void checkThatArgumentIsNonNumeric(int argumentNumber, @NonNull List<SWRLBuiltInArgument> arguments)
			throws SWRLBuiltInException
	{
	...
	@Override
	public void checkThatArgumentIsAByte(int argumentNumber, @NonNull List<SWRLBuiltInArgument> arguments)
			throws SWRLBuiltInException
	{
		if (!isArgumentAByte(argumentNumber, arguments))
			throw new InvalidSWRLBuiltInArgumentException(argumentNumber, makeInvalidArgumentTypeMessage(
					arguments.get(argumentNumber), "byte"));
	}

	@Override
	public boolean isArgumentAByte(int argumentNumber, @NonNull List<SWRLBuiltInArgument> arguments)
			throws SWRLBuiltInException
	{
	...
	@Override
	public short getArgumentAsAByte(int argumentNumber, @NonNull List<SWRLBuiltInArgument> arguments)
			throws SWRLBuiltInException
	{
	...
	@Override
	public void checkThatArgumentIsAShort(int argumentNumber, @NonNull List<SWRLBuiltInArgument> arguments)
			throws SWRLBuiltInException
	{
		if (!isArgumentAShort(argumentNumber, arguments))
			throw new InvalidSWRLBuiltInArgumentException(argumentNumber, makeInvalidArgumentTypeMessage(
					arguments.get(argumentNumber), "short"));
	}

	@Override
	public boolean isArgumentAShort(int argumentNumber, @NonNull List<SWRLBuiltInArgument> arguments)
			throws SWRLBuiltInException
	{
		return isArgumentALiteral(argumentNumber, arguments)
	...
	@Override
	public short getArgumentAsAShort(int argumentNumber, @NonNull List<SWRLBuiltInArgument> arguments)
			throws SWRLBuiltInException
	{
	...
	@Override
	public void checkThatArgumentIsAnInt(int argumentNumber, @NonNull List<SWRLBuiltInArgument> arguments)
			throws SWRLBuiltInException
	{
		if (!isArgumentAnInt(argumentNumber, arguments))
			throw new InvalidSWRLBuiltInArgumentException(argumentNumber, makeInvalidArgumentTypeMessage(
					arguments.get(argumentNumber), "int"));
	}

	@Override
	public boolean isArgumentAnInt(int argumentNumber, @NonNull List<SWRLBuiltInArgument> arguments)
			throws SWRLBuiltInException
	{
	...
	@Override
	public int getArgumentAsAnInt(int argumentNumber, @NonNull List<SWRLBuiltInArgument> arguments)
			throws SWRLBuiltInException
	{
	...
	@Override
	public int getArgumentAsAPositiveInt(int argumentNumber, @NonNull List<SWRLBuiltInArgument> arguments)
			throws SWRLBuiltInException
	{
	...
	@Override
	public boolean isArgumentALiteral(int argumentNumber, @NonNull List<SWRLBuiltInArgument> arguments)
			throws SWRLBuiltInException
	{
	...
	@Override
	public boolean isArgumentAProperty(int argumentNumber, @NonNull List<SWRLBuiltInArgument> arguments)
			throws SWRLBuiltInException
	{
		checkThatArgumentIsBound(argumentNumber, arguments);
	...
	@Override
	public boolean isArgumentADataProperty(int argumentNumber, @NonNull List<SWRLBuiltInArgument> arguments)
			throws SWRLBuiltInException
	{
		checkThatArgumentIsBound(argumentNumber, arguments);
	...
	@Override
	public boolean isArgumentAnObjectProperty(int argumentNumber, @NonNull List<SWRLBuiltInArgument> arguments)
			throws SWRLBuiltInException
	{
		checkThatArgumentIsBound(argumentNumber, arguments);
	...
	@Override
	public void checkThatArgumentIsAProperty(int argumentNumber, @NonNull List<SWRLBuiltInArgument> arguments)
			throws SWRLBuiltInException
	{
	...
	@Override
	public void checkThatArgumentIsAnObjectProperty(int argumentNumber, @NonNull List<SWRLBuiltInArgument> arguments)
			throws SWRLBuiltInException
	{
	...
	@Override
	public void checkThatArgumentIsADataProperty(int argumentNumber, @NonNull List<SWRLBuiltInArgument> arguments)
			throws SWRLBuiltInException
	{
	...
	@Override
	public boolean isArgumentAClassPropertyOrIndividual(int argumentNumber, @NonNull List<SWRLBuiltInArgument> arguments)
			throws SWRLBuiltInException
	{
	...
	@Override
	public boolean isArgumentAClass(int argumentNumber, @NonNull List<SWRLBuiltInArgument> arguments)
			throws SWRLBuiltInException
	{
		checkThatArgumentIsBound(argumentNumber, arguments);
	...
	@Override
	public void checkThatArgumentIsAClass(int argumentNumber, @NonNull List<SWRLBuiltInArgument> arguments)
			throws SWRLBuiltInException
	{
		if (!isArgumentAClass(argumentNumber, arguments))
			throw new InvalidSWRLBuiltInArgumentException(argumentNumber, makeInvalidArgumentTypeMessage(
	...
	@NonNull
	@Override
	public OWLLiteral getArgumentAsAnOWLLiteral(int argumentNumber, @NonNull List<SWRLBuiltInArgument> arguments)
			throws SWRLBuiltInException
	{
		checkThatArgumentIsALiteral(argumentNumber, arguments);
	...
	@Override
	public void checkThatArgumentIsALong(int argumentNumber, @NonNull List<SWRLBuiltInArgument> arguments)
			throws SWRLBuiltInException
	{
		if (!isArgumentALong(argumentNumber, arguments))
			throw new InvalidSWRLBuiltInArgumentException(argumentNumber, makeInvalidArgumentTypeMessage(
	...
	@Override
	public boolean isArgumentALong(int argumentNumber, @NonNull List<SWRLBuiltInArgument> arguments)
			throws SWRLBuiltInException
	{
	...
	@Override
	public long getArgumentAsALong(int argumentNumber, @NonNull List<SWRLBuiltInArgument> arguments)
			throws SWRLBuiltInException
	{
	...
	@Override
	public long getArgumentAsAPositiveLong(int argumentNumber, @NonNull List<SWRLBuiltInArgument> arguments)
			throws SWRLBuiltInException
	{
	...
	@Override
	public void checkThatArgumentIsAFloat(int argumentNumber, @NonNull List<SWRLBuiltInArgument> arguments)
			throws SWRLBuiltInException
	{
		if (!isArgumentAFloat(argumentNumber, arguments))
			throw new InvalidSWRLBuiltInArgumentException(argumentNumber, makeInvalidArgumentTypeMessage(
	...
	@Override
	public boolean isArgumentAFloat(int argumentNumber, @NonNull List<SWRLBuiltInArgument> arguments)
			throws SWRLBuiltInException
	{
		return isArgumentALiteral(argumentNumber, arguments)
	...
	@Override
	public float getArgumentAsAFloat(int argumentNumber, @NonNull List<SWRLBuiltInArgument> arguments)
			throws SWRLBuiltInException
	{
	...
	@Override
	public void checkThatArgumentIsADouble(int argumentNumber, @NonNull List<SWRLBuiltInArgument> arguments)
			throws SWRLBuiltInException
	{
		if (!isArgumentADouble(argumentNumber, arguments))
			throw new InvalidSWRLBuiltInArgumentException(argumentNumber, makeInvalidArgumentTypeMessage(
	...
	@Override
	public boolean isArgumentADouble(int argumentNumber, @NonNull List<SWRLBuiltInArgument> arguments)
			throws SWRLBuiltInException
	{
		return isArgumentALiteral(argumentNumber, arguments)
	...
	@Override
	public double getArgumentAsADouble(int argumentNumber, @NonNull List<SWRLBuiltInArgument> arguments)
			throws SWRLBuiltInException
	{
		checkArgumentNumber(argumentNumber, arguments);
	...
	@Override
	public void checkThatArgumentIsABoolean(int argumentNumber, @NonNull List<SWRLBuiltInArgument> arguments)
			throws SWRLBuiltInException
	{
		if (!isArgumentABoolean(argumentNumber, arguments))
			throw new InvalidSWRLBuiltInArgumentException(argumentNumber, makeInvalidArgumentTypeMessage(
	...
	@Override
	public boolean isArgumentABoolean(int argumentNumber, @NonNull List<SWRLBuiltInArgument> arguments)
			throws SWRLBuiltInException
	{
		return isArgumentALiteral(argumentNumber, arguments)
	...
	@Override
	public boolean getArgumentAsABoolean(int argumentNumber, @NonNull List<SWRLBuiltInArgument> arguments)
			throws SWRLBuiltInException
	{
	...
	@Override
	public void checkThatArgumentIsAString(int argumentNumber, @NonNull List<SWRLBuiltInArgument> arguments)
			throws SWRLBuiltInException
	{
		if (!isArgumentAString(argumentNumber, arguments))
			throw new InvalidSWRLBuiltInArgumentException(argumentNumber, makeInvalidArgumentTypeMessage(
	...
	@Override
	public boolean isArgumentAString(int argumentNumber, @NonNull List<SWRLBuiltInArgument> arguments)
			throws SWRLBuiltInException
	{
	...
	@NonNull
	@Override
	public String getArgumentAsAString(int argumentNumber, @NonNull List<SWRLBuiltInArgument> arguments)
			throws SWRLBuiltInException
	{
		checkThatArgumentIsAString(argumentNumber, arguments);
	...
	@Override
	public void checkThatArgumentIsATime(int argumentNumber, @NonNull List<SWRLBuiltInArgument> arguments)
			throws SWRLBuiltInException
	{
	...
	@Override
	public boolean isArgumentATime(int argumentNumber, @NonNull List<SWRLBuiltInArgument> arguments)
			throws SWRLBuiltInException
	{
	...
	@Override
	@NonNull
	public XSDTime getArgumentAsATime(int argumentNumber, @NonNull List<SWRLBuiltInArgument> arguments)
			throws SWRLBuiltInException
	{
	...
	@Override
	public void checkThatArgumentIsADate(int argumentNumber, @NonNull List<SWRLBuiltInArgument> arguments)
			throws SWRLBuiltInException
	{
	...
	@Override
	public boolean isArgumentADate(int argumentNumber, @NonNull List<SWRLBuiltInArgument> arguments)
			throws SWRLBuiltInException
	{
	...
	@NonNull
	@Override
	public XSDDate getArgumentAsADate(int argumentNumber, @NonNull List<SWRLBuiltInArgument> arguments)
			throws SWRLBuiltInException
	{
	...
	@Override
	public void checkThatArgumentIsADateTime(int argumentNumber, @NonNull List<SWRLBuiltInArgument> arguments)
			throws SWRLBuiltInException
	{
	...
	@Override
	public boolean isArgumentADateTime(int argumentNumber, @NonNull List<SWRLBuiltInArgument> arguments)
			throws SWRLBuiltInException
	{
		return isArgumentALiteral(argumentNumber, arguments)
	...
	@NonNull
	@Override
	public XSDDateTime getArgumentAsADateTime(int argumentNumber, @NonNull List<SWRLBuiltInArgument> arguments)
			throws SWRLBuiltInException
	{
	...
	@Override
	public void checkThatArgumentIsADuration(int argumentNumber, @NonNull List<SWRLBuiltInArgument> arguments)
			throws SWRLBuiltInException
	{
	...
	@Override
	public boolean isArgumentADuration(int argumentNumber, @NonNull List<SWRLBuiltInArgument> arguments)
			throws SWRLBuiltInException
	{
		return isArgumentALiteral(argumentNumber, arguments)
	...
	@NonNull
	@Override
	public XSDDuration getArgumentAsADuration(int argumentNumber, @NonNull List<SWRLBuiltInArgument> arguments)
			throws SWRLBuiltInException
	{
	...
	@Override
	public boolean hasUnboundArguments(@NonNull List<SWRLBuiltInArgument> arguments)
	{
	...
	@Override
	public void checkThatAllArgumentsAreBound(@NonNull List<SWRLBuiltInArgument> arguments) throws SWRLBuiltInException
	{
	...
	@Override
	public void checkThatArgumentIsBound(int argumentNumber, @NonNull List<SWRLBuiltInArgument> arguments)
			throws SWRLBuiltInException
	{
	...
	@Override
	public boolean isUnboundArgument(int argumentNumber, @NonNull List<SWRLBuiltInArgument> arguments)
			throws SWRLBuiltInException
	{
		checkArgumentNumber(argumentNumber, arguments);
	 ...
	 */
	@Override
	public int getFirstUnboundArgument(@NonNull List<SWRLBuiltInArgument> arguments)
	{
	...
	@Override
	public void checkForUnboundArguments(@NonNull List<SWRLBuiltInArgument> arguments) throws SWRLBuiltInException
	{
	...
	@Override
	public void checkForUnboundArguments(@NonNull List<SWRLBuiltInArgument> arguments, String message)
			throws SWRLBuiltInException
	{
		if (hasUnboundArguments(arguments))
	...
	@Override
	public void checkThatArgumentsWereBoundVariables(@NonNull List<SWRLBuiltInArgument> arguments, String message)
			throws SWRLBuiltInException
	{
		for (SWRLBuiltInArgument argument : arguments)
	...
	@Override
	public void checkForUnboundNonFirstArguments(@NonNull List<SWRLBuiltInArgument> arguments)
			throws SWRLBuiltInException
	{
	...
	@Override
	public String getVariablePrefixedName(int argumentNumber, @NonNull List<SWRLBuiltInArgument> arguments)
			throws SWRLBuiltInException
	{
		checkArgumentNumber(argumentNumber, arguments);
	...
	@NonNull
	private String makeInvalidArgumentTypeMessage(@NonNull SWRLBuiltInArgument argument, String expectedTypeName)
	{
	 ...
	 */
	@Override
	public Object getArgumentAsAPropertyValue(int argumentNumber, @NonNull List<SWRLBuiltInArgument> arguments)
			throws SWRLBuiltInException
	{
	...
	@NonNull
	@Override
	public List<SWRLBuiltInArgument> cloneArguments(@NonNull List<SWRLBuiltInArgument> arguments)
	{
		return new ArrayList<>(arguments);
	}

	@Override
	public boolean processResultArgument(@NonNull List<SWRLBuiltInArgument> arguments, int resultArgumentNumber,
	...
	@NonNull
	private Literal getArgumentAsALiteral(int argumentNumber, @NonNull List<SWRLBuiltInArgument> arguments)
			throws SWRLBuiltInException
	{
		checkThatArgumentIsALiteral(argumentNumber, arguments);
