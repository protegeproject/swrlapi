...
class SWRLTokenizer
{
	...
	@NonNull
	public SWRLToken getToken(@NonNull String noTokenMessage) throws SWRLParseException
	{
		if (hasMoreTokens())
			return getToken();
		else
	...
	@NonNull
	public SWRLToken peekToken(@NonNull String message) throws SWRLParseException
	{
	...
	@NonNull
	private SWRLParseException generateEndOfRuleException(@NonNull String message)
	{
