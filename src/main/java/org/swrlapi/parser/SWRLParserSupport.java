...
public class SWRLParserSupport
{
	...
	@NonNull public SWRLRule getSWRLRule(@NonNull String ruleName, @NonNull Set<SWRLAtom> head, @NonNull Set<SWRLAtom> body,
			String comment, boolean isEnabled)
	{
	...
	private OWLAnnotationProperty getOWLAnnotationProperty(@NonNull String annotationPropertyShortName)
			throws SWRLParseException
	{
